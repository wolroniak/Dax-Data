...
public class SingleStocksView extends HorizontalLayout {
    ...
    public SingleStocksView() throws IOException {
        ...
        comboBoxCompanies = Controller.getComboBoxCompany("7d", "5m", this);

        add(comboBoxCompanies, buttonMax, button10years, button5years, button2years, button1year, button6months, button3months, button1month, button1week, button1day);
        add(chartTypesComboBox);
        buildChartView("7d", "5m", chartTypesComboBox.getValue(), comboBoxCompanies.getValue().getSymbol());
